...
// var_dump($_SERVER["REQUEST_URI"] = "index.php");
// die;
...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary shadow-sm p-3 mb-5 bg-body-tertiary rounded">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="./index.php">Show Data Student</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        <form method="POST" action="/db/student/create.php">
            <div class="mb-3">
